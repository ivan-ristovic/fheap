...
\label{sec:Exp}
Kako bismo ispitali efikasnost na\v{s}e implementacije Fibona\v{c}ijevog hipa, implementirali smo i standardan binarni hip. U narednim podsekcijama su prikazani rezultati poređenja efikasnosti ova dva hipa.

Poređenje efikasnosti operacije \texttt{decrease\_key} vr\v{s}imo na slede\'{c}i na\v{c}in:
\begin{itemize}
